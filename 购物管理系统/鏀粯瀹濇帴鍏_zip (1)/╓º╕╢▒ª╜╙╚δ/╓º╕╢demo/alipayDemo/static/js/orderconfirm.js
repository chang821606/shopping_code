function orders() {
            $.ajax({
                    type: 'get',
                    url: 'http://172.162.18.60:8888/order/processing/',
                    datatype: 'json',
                    async: false,
                    data:{"status":0},
                    success: function (response) {
                        ...
                        $(function () {
                         ...
                         $("#go_pay").click(function () {
                             // window.location='http://172.162.18.60:5000/order_p?address_id=1'
                             $.ajax({
                                    type:"post",
                                    url: 'http://172.162.18.60:8888/order/processing/',
                                    datatype: 'json',
                                    async: false,
                                    data:JSON.stringify({"address_id":1,
                                         "status":0
                                    }),
                                    success: function (response) {
                                         window.location='http://127.0.0.1/templates/payment.html'
                                    }
                             })
